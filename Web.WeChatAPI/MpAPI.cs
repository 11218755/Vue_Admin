...
namespace Web.WeChatAPI
{
    public class MpAPI: BaseAPI
    {
        ...
        public static Oauth2_Access_tokenRes Oauth2_Access_token(string appid, string secret, string code)
        {
            var url = "https://api.weixin.qq.com/sns/oauth2/access_token?appid={0}&secret={1}&code={2}&grant_type=authorization_code";
            url = string.Format(url, appid, secret, code);

            return GetObject<Oauth2_Access_tokenRes>(url);
        }
        #endregion
        ...
        #region JS-SDK使用权限签名算法(企业号) 获取企业的jsapi_ticket
        /// <summary>
        /// JS-SDK使用权限签名算法
        /// </summary>
        /// <param name="access_token"></param>
        /// <returns></returns>
        public static Get_jsapi_ticketRes NewGet_jsapi_ticket(string access_token)
        {
        ...
        #region JS-SDK 获取应用的jsapi_ticket
        /// <summary>
        /// JS-SDK 获取应用的jsapi_ticket
        /// </summary>
        /// <param name="access_token"></param>
        /// <returns></returns>
        public static Get_jsapi_ticketRes Get_jsapi_ticket(string access_token)
        {
            var url = "https://qyapi.weixin.qq.com/cgi-bin/ticket/get?type=agent_config&access_token=";
            url += access_token;
        ...
        public static Media_UploadimgRes Media_Uploadimg(string access_token, string file)
        {
            ...
            {
                var exp_msg = string.Format("curl调用失败，file：{0}， access_token={1}",
                    file, access_token);
                LogHelper.logError(exp_msg, ex);
                throw ex;
            }
        }
        #endregion
        ...
        public static Mass_SendallRes Mass_Sendall_OpenId(string access_token, MassSend massSend)
        {
            ...
            if (massSend.msgtype == "video")
            {
                massSend.msgtype = "mpvideo";
            }
            switch (massSend.msgtype)
            {
                case "mpnews":
                ...
                case "video":
                    ...
                    massSend.msgtype = "video";
                    break;
                case "mpvideo":
                    var _uploadVideo = UploadVideo_OpenId(access_token, massSend);
                    dpost.mpvideo = new
                    {
                        media_id = _uploadVideo.media_id,
                        title = massSend.title,
                        description = massSend.description
                    };
                    massSend.msgtype = "mpvideo";
        ...
        /// <param name="articles"></param>
        /// <returns></returns>
        public static Media_UploadnewsRes Media_add_news(string access_token, List<ArticlesMp> articles)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/material/add_news?access_token=";
            url += access_token;
        ...
        /// <param name="file"></param>
        /// <returns></returns>
        public static Media_UploadimgRes Media_Get_Imgurl(string access_token, string file)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/media/uploadimg?access_token=";
            url += access_token;
        ...
        /// <param name="file"></param>
        /// <returns></returns>
        public static MediaUploadRes Media_add_material(string access_token, EnumUploadType type, string file)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/material/add_material?access_token={0}&type={1}";
            url = string.Format(url, access_token, type);

            string json = WebClientUploadFile.HttpUploadFile(url, file);
            MediaUploadRes res = JsonConvert.DeserializeObject<MediaUploadRes>(json);
            if (string.IsNullOrEmpty(res.errcode))
            {
                res.errcode = "0";
        ...
        /// <param name="media_id"></param>
        /// <returns></returns>
        public static Media_NewsItem Media_get_material(string access_token,string media_id)
        {
            ...
            return PostObject<Media_NewsItem>(url, post);
        ...
        /// <param name="media_id"></param>
        /// <returns></returns>
        public static BaseRes Media_del_material(string access_token, string media_id)
        {
        ...
        /// <param name="media_id"></param>
        /// <returns></returns>
        public static BaseRes Media_update_material(string access_token, string media_id,string index, ArticlesMp articles)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/material/update_news?access_token=";
            url += access_token;
        ...
        /// <param name="access_token"></param>
        /// <returns></returns>
        public static MaterialCount Media_get_materialcount(string access_token)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/material/get_materialcount?access_token=";
            url += access_token;

            return GetObject<MaterialCount>(url);
        ...
        /// <param name="access_token"></param>
        /// <returns></returns>
        public static Batchget_Material Media_batchget_material(string access_token, string type, int offset,int count)
        {
            ...
            return PostObject<Batchget_Material>(url, post);
        }
        #endregion
        ...
        /// <param name="access_token"></param>
        /// <returns></returns>
        public static Groups_GetRes Tags_Get(string access_token)
        {
        ...
        /// <param name="to_groupid"></param>
        /// <returns></returns>
        public static BaseRes Tags_Members_Batchupdate(string access_token, List<string> openid_list, int to_groupid)
        {
        ...
        /// <param name="to_groupid"></param>
        /// <returns></returns>
        public static BaseRes Tags_Members_Batchdel(string access_token, List<string> openid_list, int to_groupid)
        {
        ...
        public static User_Info_BatchgetRes User_Info_Batchget(string access_token, List<string> openids)
        {
            ...
            return PostObject<User_Info_BatchgetRes>(url, post);
        }
        #endregion
        ...
        /// <returns></returns>
        public static Qrcode_CreateRes TQrcode_Create(string access_token, string action_name, int expire_seconds)
        {
                ...
                case "QR_SCENE":
                    var postId = new
                    {
                        ...
                        action_info = new
                        {
                            scene = new
                            {
                                scene_id = new Random().Next(1, 100001)
                            }
                        }
                    };
                    return PostObject<Qrcode_CreateRes>(url, postId);
                case "QR_STR_SCENE":
                    var postStr = new
                    {
                        expire_seconds = expire_seconds,
                    ...
                    return PostObject<Qrcode_CreateRes>(url, postStr);
            }

            return new Qrcode_CreateRes() { };
        }
        #endregion
        ...
        /// <returns></returns>
        public static Qrcode_CreateRes FQrcode_Create(string access_token, string action_name)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=";
            url += access_token;
        ...
        public static MediaGetRes Showqrcode(string ticket, string filepath)
        {
            ...
            try
            {
                ...
                {
                    return new MediaGetRes() { errcode = "-1" };
                }
                else
                {
                    //filename = StringHelper.SubString(disposition, "filename=\"", "\"");
                    return new MediaGetRes() { errcode = "0" };
                }
            }
            catch
            {
        ...
        /// </summary>
        /// <param name="access_token"></param>
        /// <param name="msg_data_id"></param>
        /// <returns></returns>
        public static Comment_Get GetComment_List(string access_token, string msg_data_id,int index,int begin,int count, int type)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/close?access_token=";
            url += access_token;
            ...
            return PostObject<Comment_Get>(url, post);
        }
        #endregion
        ...
        /// <param name="access_token"></param>
        /// <param name="msg_data_id"></param>
        /// <param name="user_comment_id"></param>
        /// <returns></returns>
        public static BaseRes Comment_markelect(string access_token, string msg_data_id, string user_comment_id)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/markelect?access_token=";
            url += access_token;
        ...
        /// <param name="user_comment_id"></param>
        /// <returns></returns>
        public static BaseRes Comment_unmarkelect(string access_token, string msg_data_id, string user_comment_id)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/unmarkelect?access_token=";
            url += access_token;
        ...
        /// <param name="user_comment_id"></param>
        /// <returns></returns>
        public static BaseRes Comment_delete(string access_token, string msg_data_id, string user_comment_id)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/delete?access_token=";
            url += access_token;
        ...
        /// <param name="user_comment_id"></param>
        /// <returns></returns>
        public static BaseRes Comment_reply_add(string access_token, string msg_data_id, string user_comment_id,string content)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/reply/add?access_token=";
            url += access_token;
        ...
        /// <param name="user_comment_id"></param>
        /// <returns></returns>
        public static BaseRes Comment_reply_delete(string access_token, string msg_data_id, string user_comment_id)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/reply/delete?access_token=";
            url += access_token;
        ...
        /// <param name="user_comment_id"></param>
        /// <returns></returns>
        public static BaseRes Comment_open(string access_token, string msg_data_id)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/comment/open?access_token=";
            url += access_token;
        ...
        /// <param name="expire_seconds"></param>
        /// <returns></returns>
        public static Qrcode_CreateRes TQrcode_Add(string access_token, string action_name, int expire_seconds,int scene_id,string scene_str)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=";
            url += access_token;
            switch (action_name)
        ...
        /// <param name="scene_str"></param>
        /// <returns></returns>
        public static Qrcode_CreateRes FQrcode_Add(string access_token, string action_name,int scene_id,string scene_str)
        {
            string url = "https://api.weixin.qq.com/cgi-bin/qrcode/create?access_token=";
            url += access_token;
